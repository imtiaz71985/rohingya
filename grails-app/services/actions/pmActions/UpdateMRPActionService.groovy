            ...
            if (detailsIdStr) {
                ...
                if (indicatorType.equals("Dividable") || indicatorType.equals("Dividable%")) {
                    ...
                    if (details.monthName == monthName) {
                        ...
                        if ((lst.size() == 0 ? details.target : lst[0].target) > (lst.size() == 0 ? 0 : lst[0].achievement + details.achievement)) {
                            params.put("totalTarget", lst.size() == 0 ? details.target : lst[0].target)
                            params.put("totalAchievement", lst.size() == 0 ? details.achievement : (lst[0].achievement + details.achievement))
