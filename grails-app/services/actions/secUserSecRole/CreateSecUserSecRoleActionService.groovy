...
class CreateSecUserSecRoleActionService extends BaseService implements ActionServiceIntf {
    ...
    private String APPLICATION_ID = PropertiesReader.getProperty ("application.id", PropertiesReader.CONFIG_FILE_DB)
    ...
    private SecUserSecRole buildObject(Map parameterMap) {
        ...
        userRole.appsId = Long.parseLong(APPLICATION_ID)
        return userRole
    }
}
