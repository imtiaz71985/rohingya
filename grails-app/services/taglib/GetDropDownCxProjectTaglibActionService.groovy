...
@Transactional
class GetDropDownCxProjectTaglibActionService extends BaseService implements ActionServiceIntf {
     ...
     * @param lstCxProject - list for select 'options'
     * @param dropDownAttributes - a map containing the attributes of drop down
     * @return - html string for select
     */
    private String buildDropDown(def lstCxProject, Map dropDownAttributes) {
        ...
        String jsonData = lstCxProject as JSON
        String script = """ \n
