...
//        List<GroovyRowResult> lst = pmActionsService.lstMeetingStatus(params.month.toString())
        List<GroovyRowResult> lst = pmActionsService.lstGoalWiseActionStatus(params.month.toString())
        render lst as JSON
    }
    def lstUserPieDashboard() {
        List<GroovyRowResult> lst = pmActionsService.lstCriticalDecisionStatus(params.month.toString())
