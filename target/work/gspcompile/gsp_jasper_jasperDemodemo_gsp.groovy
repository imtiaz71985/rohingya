...
@GrailsPlugin(name='jasper', version='1.10.0')
class gsp_jasper_jasperDemodemo_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/jasper-1.10.0/grails-app/views/jasperDemo/demo.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1411334004000L
